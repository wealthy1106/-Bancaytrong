...
INSERT INTO `myweb`.`spnb` (`idspb`, `hinh1`, `hinh2`, `hinh3`)
VALUES ('1', 'hinhanh/caykieng/hoa/huong duong.jpg', 'hinhanh/cây ăn trái/mitnghetuquy.PNG', 'hinhanh/caykieng/caytrongnha/vanloc.PNG');
...
INSERT INTO `myweb`.`thongtinlienhe` (`malh`, `diachi`, `email`, `SDT`) 
VALUES ('lh1', ' 31/8 Mậu Thân,An Hòa, Ninh Kiều, Cần Thơ', 'caytrongnhanong@gmail.com', '0293819022');
